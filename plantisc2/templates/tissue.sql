CREATE TABLE IF NOT EXISTS `kinintype` (
...
INSERT IGNORE INTO `kinintype` (`id`, `kinintype`) VALUES
(1, 'KINETIN'),
(2, 'BAP');
...
INSERT IGNORE INTO `treatment` (`id`, `treatment`) VALUES
(1, 'AE'),
(2, 'SH');
...
INSERT IGNORE INTO `type` (`id`, `type`) VALUES
(1, 'SHOOT'),
(2, 'LEAF'),
(3, 'BUD'),
(4, 'ROOT');
...
INSERT IGNORE INTO `upload` (`userid`, `auxin`, `auxinname`, `cytokinin`, `cytokininname`, `response`, `treatment`, `type`, `fileid`, `contact`) VALUES
...
INSERT IGNORE INTO `user` (`userid`, `names`, `username`, `password`, `contact`) VALUES
